...
This work modelled biased Pauli noise and heralded erasure on the toric code and decoded each with the appropriate decoder, in order to make the very different thresholds of the two regimes vivid and reproducible, and to test honestly whether bias alone helps an untailored code.
