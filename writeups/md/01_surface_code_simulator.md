...
Many high-quality libraries exist for stabiliser simulation and decoding, but a researcher benefits from a compact, end-to-end pipeline whose statistics are easy to read and test. This work was undertaken to build such a pipeline and to verify that it recovers the textbook threshold behavior, establishing a base layer on which decoder comparisons, machine-learning experiments and paper reproductions could be built.
