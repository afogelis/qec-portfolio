...
Continuous integration on a clean checkout caught a packaging defect that local testing had masked, and verification of every citation corrected an attribution error in one of the reproduction repositories.
