...
This work was undertaken to build those codes from first principles and to decode them with the decoder they were designed for, belief propagation with ordered-statistics post-processing, in order to demonstrate the rate advantage of qLDPC codes over the surface code on a common, reproducible footing.
